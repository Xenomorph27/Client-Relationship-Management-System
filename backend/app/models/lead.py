...
class Lead(Base):
	__tablename__="leads"
	id=Column(Integer, primary_key=True, index=True) # Check , recommended string but Stated Integer (myself)
	...
	organisation=relationship("Organisation", back_poplulates="lead")
